...
import org.launchcode.DirtyDishesAndEmptyPlates.controllers.HomeController;
...
public class AuthenticationFilter extends HandlerInterceptorAdapter {
    ...
    private static final List<String> whitelist = Arrays.asList("/", "/login", "/register", "/logout", "/css", "/recipe");
    @Override
